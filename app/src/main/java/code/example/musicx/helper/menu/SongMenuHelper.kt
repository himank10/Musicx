...
package code.example.musicx.helper.menu
...
import code.example.musicx.activities.tageditor.SongTagEditorActivity
import code.example.musicx.dialogs.AddToPlaylistDialog
import code.example.musicx.dialogs.DeleteSongsDialog
import code.example.musicx.dialogs.SongDetailDialog
import code.example.musicx.helper.MusicPlayerRemote
import code.example.musicx.interfaces.IPaletteColorHolder
...
import code.example.musicx.util.RingtoneManager
