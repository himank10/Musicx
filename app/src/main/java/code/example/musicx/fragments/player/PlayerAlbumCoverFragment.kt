...
package code.example.musicx.fragments.player

import android.os.Bundle
import android.view.View
import androidx.viewpager.widget.ViewPager
import code.example.musicx.R
import code.example.musicx.adapter.album.AlbumCoverPagerAdapter
import code.example.musicx.adapter.album.AlbumCoverPagerAdapter.AlbumCoverFragment
import code.example.musicx.fragments.NowPlayingScreen.*
import code.example.musicx.fragments.base.AbsMusicServiceFragment
import code.example.musicx.helper.MusicPlayerRemote
import code.example.musicx.transform.CarousalPagerTransformer
import code.example.musicx.transform.ParallaxPagerTransformer
