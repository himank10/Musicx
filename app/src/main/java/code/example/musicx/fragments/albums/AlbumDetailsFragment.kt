...
package code.example.musicx.fragments.albums
...
import code.example.appthemehelper.common.ATHToolbarActivity.getToolbarBackgroundColor
import code.example.appthemehelper.util.ATHUtil
import code.example.appthemehelper.util.ToolbarContentTintHelper
import code.example.musicx.EXTRA_ALBUM_ID
import code.example.musicx.EXTRA_ARTIST_ID
import code.example.musicx.R
import code.example.musicx.activities.tageditor.AbsTagEditorActivity
import code.example.musicx.activities.tageditor.AlbumTagEditorActivity
import code.example.musicx.adapter.album.HorizontalAlbumAdapter
import code.example.musicx.adapter.song.SimpleSongAdapter
import code.example.musicx.dialogs.AddToPlaylistDialog
import code.example.musicx.dialogs.DeleteSongsDialog
import code.example.musicx.extensions.applyColor
import code.example.musicx.extensions.applyOutlineColor
import code.example.musicx.extensions.findActivityNavController
import code.example.musicx.extensions.show
import code.example.musicx.fragments.base.AbsMainActivityFragment
import code.example.musicx.glide.AlbumGlideRequest
import code.example.musicx.glide.ArtistGlideRequest
import code.example.musicx.glide.RetroMusicColoredTarget
import code.example.musicx.glide.SingleColorTarget
import code.example.musicx.helper.MusicPlayerRemote
import code.example.musicx.helper.SortOrder
import code.example.musicx.interfaces.IAlbumClickListener
import code.example.musicx.model.Album
import code.example.musicx.model.Artist
import code.example.musicx.network.model.LastFmAlbum
