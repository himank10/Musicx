...
package code.example.musicx.fragments.player.circle
...
import code.example.musicx.extensions.accentColor
...
import code.example.musicx.fragments.base.AbsPlayerControlsFragment
import code.example.musicx.fragments.base.AbsPlayerFragment
import code.example.musicx.helper.MusicPlayerRemote
import code.example.musicx.helper.MusicProgressViewUpdateHelper
import code.example.musicx.helper.PlayPauseButtonOnClickHandler
import code.example.musicx.misc.SimpleOnSeekbarChangeListener
...
import code.example.musicx.views.SeekArc
import code.example.musicx.volume.AudioVolumeObserver
import code.example.musicx.volume.OnAudioVolumeChangedListener
