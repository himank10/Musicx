...
package code.example.musicx.fragments.folder;
...
import code.example.musicx.adapter.SongFileAdapter;
import code.example.musicx.fragments.base.AbsMainActivityFragment;
import code.example.musicx.helper.MusicPlayerRemote;
import code.example.musicx.helper.menu.SongMenuHelper;
import code.example.musicx.helper.menu.SongsMenuHelper;
import code.example.musicx.interfaces.ICabHolder;
import code.example.musicx.interfaces.ICallbacks;
import code.example.musicx.interfaces.IMainActivityFragmentCallbacks;
import code.example.musicx.misc.DialogAsyncTask;
import code.example.musicx.misc.UpdateToastMediaScannerCompletionListener;
import code.example.musicx.misc.WrappedAsyncTaskLoader;
import code.example.musicx.model.Song;
import code.example.musicx.util.DensityUtil;
import code.example.musicx.util.FileUtil;
import code.example.musicx.util.PreferenceUtil;
import code.example.musicx.util.RetroColorUtil;
import code.example.musicx.util.ThemedFastScroller;
import code.example.musicx.views.BreadCrumbLayout;
import code.example.musicx.views.ScrollingViewOnApplyWindowInsetsListener;
...
import static code.example.appthemehelper.common.ATHToolbarActivity.getToolbarBackgroundColor;
