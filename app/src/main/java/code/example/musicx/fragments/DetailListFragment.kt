...
package code.example.musicx.fragments
...
import code.example.musicx.adapter.album.AlbumAdapter
import code.example.musicx.adapter.artist.ArtistAdapter
import code.example.musicx.adapter.song.SongAdapter
import code.example.musicx.db.toSong
import code.example.musicx.extensions.dipToPix
