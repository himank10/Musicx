...
package code.example.musicx.fragments.player.gradient
...
import code.example.musicx.RetroBottomSheetBehavior
import code.example.musicx.adapter.song.PlayingQueueAdapter
import code.example.musicx.db.PlaylistEntity
import code.example.musicx.db.SongEntity
import code.example.musicx.db.toSongEntity
import code.example.musicx.extensions.hide
import code.example.musicx.extensions.ripAlpha
import code.example.musicx.extensions.show
import code.example.musicx.fragments.VolumeFragment
