...
import code.example.musicx.activities.DriveModeActivity;
import code.example.musicx.activities.LicenseActivity;
import code.example.musicx.activities.LyricsActivity;
import code.example.musicx.activities.PlayingQueueActivity;
import code.example.musicx.activities.PurchaseActivity;
import code.example.musicx.activities.SupportDevelopmentActivity;
import code.example.musicx.activities.UserInfoActivity;
import code.example.musicx.activities.WhatsNewActivity;
import code.example.musicx.activities.bugreport.BugReportActivity;
