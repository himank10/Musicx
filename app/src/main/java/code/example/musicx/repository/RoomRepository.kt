package code.example.musicx.repository

import androidx.annotation.WorkerThread
import androidx.lifecycle.LiveData
import code.example.musicx.db.BlackListStoreDao
import code.example.musicx.db.BlackListStoreEntity
import code.example.musicx.db.HistoryDao
import code.example.musicx.db.HistoryEntity
import code.example.musicx.db.LyricsDao
import code.example.musicx.db.PlayCountDao
import code.example.musicx.db.PlayCountEntity
import code.example.musicx.db.PlaylistDao
...
import code.example.musicx.db.toHistoryEntity
import code.example.musicx.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_A_Z
import code.example.musicx.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_SONG_COUNT
import code.example.musicx.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_SONG_COUNT_DESC
import code.example.musicx.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_Z_A
