...
package code.example.musicx.activities.tageditor
...
import code.example.musicx.extensions.appHandleColor
import code.example.musicx.glide.palette.BitmapPaletteTranscoder
import code.example.musicx.glide.palette.BitmapPaletteWrapper
import code.example.musicx.model.ArtworkInfo
import code.example.musicx.model.Song
import code.example.musicx.util.ImageUtil
import code.example.musicx.util.RetroColorUtil.generatePalette
import code.example.musicx.util.RetroColorUtil.getColor
import java.util.*
