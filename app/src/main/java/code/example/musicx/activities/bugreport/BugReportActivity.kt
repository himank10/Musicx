...
package code.example.musicx.activities.bugreport
...
import code.example.appthemehelper.util.MaterialUtil
...
import code.example.musicx.activities.base.AbsThemeActivity
import code.example.musicx.activities.bugreport.model.DeviceInfo
import code.example.musicx.activities.bugreport.model.Report
import code.example.musicx.activities.bugreport.model.github.ExtraInfo
import code.example.musicx.activities.bugreport.model.github.GithubLogin
import code.example.musicx.activities.bugreport.model.github.GithubTarget
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        ...
        private const val ISSUE_TRACKER_LINK = "https://github.com/himank10/Musicx"
    }
}
