...
package code.example.musicx.activities.saf;
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    addSlide(
        new SimpleSlide.Builder()
            ...
            .backgroundDark(R.color.OrangeRed)
    ...
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(R.color.coral)
            .backgroundDark(R.color.md_deep_orange_A400)
            .layout(R.layout.fragment_simple_slide_large_image)
            .build());
    addSlide(
        new SimpleSlide.Builder()
            ...
            .background(R.color.tiger)
            .backgroundDark(R.color.fire)
            .layout(R.layout.fragment_simple_slide_large_image)
            .build());
  }
}
